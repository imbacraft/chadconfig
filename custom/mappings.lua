...
M.general = {
	n = {
		...
		--Spectre
		["<leader>r"] = { "+Replace" },
		["<leader>rr"] = { "<cmd>lua require('spectre').open()<cr>", "Replace in path" },
		["<leader>rb"] = { "<cmd>lua require('spectre').open_file_search()<cr>", "Replace in the current Buffer" },
		["<leader>rw"] = { "<cmd>lua require('spectre').open_visual({select_word=true})<cr>", "Replace Word" },
